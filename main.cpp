...
//    }
    ...
    if(en.type == 'R')
    {
        glColor3f(1, 0, 0);
        glBegin(GL_LINES);
        glVertex3f(en.a, en.b, 0);
        glVertex3f(en.a, en.d, 0);

        glVertex3f(en.a, en.d, 0);
        glVertex3f(en.c, en.d, 0);

        glVertex3f(en.c, en.d, 0);
        glVertex3f(en.c, en.b, 0);
